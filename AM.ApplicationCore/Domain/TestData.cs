...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Staff hostess1 = new Staff {
            fullName = new FullName { FirstName = "hostess1", LastName = "hostess1" }, EmailAddress = "hostess1.hostess1@gmail.com", BirthDate = new DateTime(1995, 01, 01), EmployementDate = new DateTime(2020, 01, 01), Salary = 999 };
